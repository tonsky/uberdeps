...
```clojure
{:deps {uberdeps/uberdeps {:mvn/version "1.1.0"}}}
```
...
```sh
clj -Sdeps '{:aliases {:uberjar {:replace-deps {uberdeps/uberdeps {:mvn/version "1.1.0"}} :replace-paths []}}}' -M:uberjar -m uberdeps.uberjar
```
...
```clojure
:aliases {
  :uberjar {:replace-deps {uberdeps/uberdeps {:mvn/version "1.1.0"}}
            :replace-paths []
            :main-opts ["-m" "uberdeps.uberjar"]}
}
```
