...
```clojure
{:deps {uberdeps/uberdeps {:mvn/version "1.0.1"}}}
```
...
{ :paths ["src"]
  ...
  :aliases {
    :uberdeps {
      :extra-deps {uberdeps/uberdeps {:mvn/version "1.0.1"}}
...
```sh
clj -Sdeps '{:deps {uberdeps/uberdeps {:mvn/version "1.0.1"}}}' -m uberdeps.uberjar
```
