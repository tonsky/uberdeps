...
```clojure
{:deps {uberdeps/uberdeps {:mvn/version "1.1.1"}}}
```
...
```sh
clj -Sdeps '{:aliases {:uberjar {:replace-deps {uberdeps/uberdeps {:mvn/version "1.1.1"}} :replace-paths []}}}' -M:uberjar -m uberdeps.uberjar
```
